...
export default function BOM({ isMerged = false }) {
  ...
  const content = (
    <div className="space-y-6 w-full">
      ...
      <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-slate-100 grid md:grid-cols-2 gap-6 text-left">
  ...
  // Modular check: If merged in Manufacturing page, just return core UI
  if (isMerged) return content;
